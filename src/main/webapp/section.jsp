    ...
    <div class="container">
      ...
      <div class="text-center our-services">
        <div class="row">
          ...
          <%@include file="section_brandIdentity.jsp"%>
          <%@include file="section_creativeIdea.jsp"%>
          <%@include file="section_awesomeSupport.jsp"%>

          <dwes:caixeta titol="Professional Design" classe="fa-flask" cos="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore"></dwes:caixeta>
          <dwes:caixeta titol="App Development" classe="fa-bitbucket" cos="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore"></dwes:caixeta>
          <dwes:caixeta titol="Clean Code" classe="fa-gift" cos="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore"></dwes:caixeta>

          <%-- <%@include file="section_profesionalDesign.jsp"%> --%>
          <%-- <%@include file="section_appDevelopment.jsp"%> --%>
          <%-- <%@include file="section_cleanCode.jsp"%> --%>
